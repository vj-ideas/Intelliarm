...
from bot_msgs.action import Temp  # for message

import threading

threading.Thread(target=lambda: rclpy.init()).start()

action_client = ActionClient(Node("alexa_interface"),Temp,"task_server")
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_text = "Hi, how can I help to move the robot?"
        ...
        return handler_input.response_builder.response  # Corrected from response4 to response
...
skill_adapter = SkillAdapter(
    skill=skill_builder.create(), skill_id="amzn1.ask.skill.852ac8bf-538d-45d8-aee4-27dddc318f12", app=app)
